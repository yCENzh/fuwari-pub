...
description: linux/windows一键dd脚本,随时随地重装系统
tags: [dd, linux, windows, 重装]
category: 记录
---

# 话说在前

脚本[原github仓库](https://github.com/bin456789/reinstall),cnb同名

作者[bin456789](https://github.com/bin456789),cnb同名
...
> 示例：  
> linux下重装成debian13,并将ssh端口设置为10000,密码为ABCD1234@abcd  
> bash reinstall.sh debian 13 --ssh-port 10000 --password ABCD1234@abcd
